# # https://github.com/databricks/databricks-vscode/blob/036002573396c56c1b1cf2b89fc0c06c659a7bf6/packages/databricks-vscode/resources/python/00-databricks-init.py
#
...
#     spark: SparkSession = DatabricksSession.builder.serverless(enabled=True).getOrCreate()
#     sql = spark.sql
#
