...
map("n", "<leader>v", "`[v`]", { desc = "Select last operated reegion" }) -- Select last paste
map("n", "<leader>gf", vim.lsp.buf.format, { desc = "LSP format" })
...
map("t", "<C-k>", "<C-\\><C-n><C-w>k", { desc = "Terminal clear" })
